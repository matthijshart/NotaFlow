    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          onClick={onExport}
          disabled={exporting}
          className="bg-slate-800 hover:bg-slate-900 text-white font-medium py-2 px-5 rounded-lg transition-colors text-sm disabled:opacity-50 flex items-center gap-2"
        >
